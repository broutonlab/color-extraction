...
IN_TENSOR_KEY = tf.compat.v1.saved_model.signature_constants.PREDICT_INPUTS
OUT_TENSOR_KEY = tf.compat.v1.saved_model.signature_constants.PREDICT_OUTPUTS
...
class PaletteEmbeddingModel(object):
  ...
  def __init__(self):
    ...
    self._sess = tf.compat.v1.Session(graph=tf.compat.v1.Graph())
